  ...
  return (
    <nav className="side-nav">
      <div className="side-nav__brand">
        <div className="side-nav__brand-icon">{BRAND_ICON}</div>
        <div>
          <div className="side-nav__brand-name">IRPG 2026</div>
          <div className="side-nav__brand-sub">Field Reference</div>
        </div>
      </div>
      <div className="side-nav__label">Navigation</div>
      <ul>
        {NAV_ITEMS.map((item) => {
